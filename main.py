...
class _MainNavigationScreenState extends State<MainNavigationScreen> {
  ...
  final String myUserId = "ADMIN_777"; // Sizning ID ingiz
  final String adminUserId = "ADMIN_777"; // Bosh admin ID
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // MAXFIY ADMIN PANEL TUGMASI (FAQAT ADMIN UCHUN)
          if (isAdmin)
            ElevatedButton.icon(
